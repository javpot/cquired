        ...
        <section class="section-1">
         ...
         <!--  <div class="section-1-background"> </div>
            ...
            <div class="section-1-info">
                ...
                <h1>connectez-vous avec les meilleurs freelances ici !</h1>
                <div class="container-search">
                    <input type="search" placeholder="chercher votre service">
                    <img src="../../assets/loupe2.png" alt="" srcset="" class="loupe">
                </div>
                    ...
                    <div class="carousel" >
                      <ul class="slides" style="height: 50vh;">
                        ...
                        <li class="slide-container">
                          ...
                          <div class="carousel-controls">
                            <label for="img-1" class="prev-slide" style="height: 50vh;">
                              <span>&lsaquo;</span>
                            </label>
                            <label for="img-3" class="next-slide" style="height: 50vh;">
                              <span>&rsaquo;</span>
                            </label>
                          </div>
                        </li>
                        ...
                        <li class="slide-container">
                          ...
                          <div class="carousel-controls">
                            <label for="img-2" class="prev-slide" style="height: 50vh;"> 
                              <span>&lsaquo;</span>
                            </label>
                            <label for="img-1" class="next-slide" style="height: 50vh;">
                              <span>&rsaquo;</span>
                            </label>
                          </div>
                        </li>
