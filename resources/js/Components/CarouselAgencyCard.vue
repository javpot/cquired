...
defineProps({
    title: String,
    data: Array, // liste des agencies/freelancers correspondant au filtre
});
</script>
...
<template>
    <section class="shadow-lg">
        <div class="flex flex-row justify-between">
            <h2
                class="w-full font-semibold text-2xl text-gray-800 leading-tight align-middle left-0 ml-7 mt-8"
            >
                {{ title }}
            </h2>
            <Link
